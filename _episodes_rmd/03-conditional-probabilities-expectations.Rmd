...
sum(y==1)/length(y) ##expectaion of Y mean(y)
1. Generate some random data to imitate heights for men (0) and women (1):
n = 10000
set.seed(1)
men = rnorm(n,176,7) #height in centimeters women = rnorm(n,162,7) #height in centimeters y = c(rep(0,n),rep(1,n))
x = round(c(men,women))
##mix it up
...
3. NowmakeaplotofE(Y|X=x)forx=seq(160,178)usingthedatageneratedinexercise
1.
