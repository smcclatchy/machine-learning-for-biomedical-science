...
# Instead, please edit 04-smoothing.md in _episodes_rmd/
source: Rmd
title: "Smoothing"
teaching: 30
exercises: 30
...
<img src="../fig/rmd-04-MAplot-1.png" alt="MA-plot comparing gene expression from two arrays." width="756" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-04-MAplot_with_regression_line-1.png" alt="MA-plot comparing gene expression from two arrays with fitted regression line. The two colors represent positive and negative residuals." width="756" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-04-binsmoother-1.png" alt="MAplot comparing gene expression from two arrays with bin smoother fit shown for two points." width="756" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-04-bin_smoothing_demo-1.png" alt="Illustration of how bin smoothing estimates a curve. Showing 12 steps of process." width="738" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-04-bin_smooth_final-1.png" alt="MA-plot with curve obtained with bin-smoothed curve shown." width="756" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-04-loess-1.png" alt="MA-plot comparing gene expression from two arrays with bin local regression fit shown for two points." width="756" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-04-loess_demo-1.png" alt="Illustration of how loess estimates a curve. Showing 12 steps of the process." width="738" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-04-loess_final-1.png" alt="MA-plot with curve obtained with loess." width="756" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-04-loess2-1.png" alt="Loess fitted with the loess function." width="738" style="display: block; margin: auto;" />
